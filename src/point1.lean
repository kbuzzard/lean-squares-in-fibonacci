...
-- Su, with a lot of help from Kenny, Chris
open nat

--#check @zmodp.fermat_little
-- zmodp.fermat_little : ∀ {p : ℕ} (hp : prime p) {a : zmodp p hp}, a ≠ 0 → a ^ (p - 1) = 1
...
rw this0 at this1,
rw ←a5 at this1,
have this2 := a2 a1 this1 a4, 
have this3 := _root_.pow_add (- 1 : ℤ) a1 2,
rw this3,
...
simp at a321,
have a222 : (↑x ^ 2) ^ m ≡ ↑x ^ (2 * m) [ZMOD p], from (@nat.pow_pow_mod x m p a),
...
have ans := one_ne_neg_one_of_odd p a important,
